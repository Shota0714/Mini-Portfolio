...
export const projectsData: Project[] = [
    {
        id: 1,
        image: <Image src="/php.jpeg" alt="php" width="500" height="334" />,
        title: "Travel Site",
    ...
    {
        id: 2,
        image: <Image src="/class.jpeg" alt="class" width="500" height="334" />,
    ...
    {
        id: 3,
        image: <Image src="/portfolio.jpeg" alt="portfolio" width="500" height="334" />,
